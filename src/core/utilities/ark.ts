...
import { Hex} from "hashswap-zilliqa-js-sdk/lib/hex";
...
export class ArkClient {
  ...
  async approveAllowanceIfRequired(tokenAddress: string, ownerAddress: string, zilswap: Hex) {
  ...
  // TODO: Refactor zilswap SDK as instance member;
  async approveAllowance(tokenAddress: string, zilswap: Hex) {
    const args = [{
      vname: "to",
      type: "ByStr20",
  ...
  // TODO: Refactor zilswap SDK as instance member;
  async wrapZil(amount: BigNumber, zilswap: Hex) {
    const minGasPrice = (await zilswap.zilliqa.blockchain.getMinimumGasPrice()).result as string;
    const callParams = {
  ...
  // TODO: Refactor zilswap SDK as instance member;
  async executeTrade(executeParams: ArkClient.ExecuteTradeParams, zilswap: Hex, wallet?: ConnectedWallet) {
  ...
  // TODO: Refactor zilswap SDK as instance member;
  async voidCheque(voidChequeParams: ArkClient.VoidChequeParams, zilswap: Hex) {
