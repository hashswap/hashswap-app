...
*/
  ...
  const onAddSponsor = () => {
    ...
    runAddSponsor(async () => {
      ...
      const zilBalance = bnOrZero(husdToken!.balance).shiftedBy(-husdToken.decimals);
  ...
  if (poolToken) {
    ...
    showTxApprove = bnOrZero(husdToken.allowances?.[byte20ContractAddress]).comparedTo(addHusdUnitlessAmount) < 0
  }
