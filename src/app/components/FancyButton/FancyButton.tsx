...
const FancyButton: React.FC<FancyButtonProps> = (props: any) => {
  const { children, loading, className, containerClass, walletRequired, disabled, loadingTxApprove, showTxApprove, contentTxApprove, onClickTxApprove, onClick, ...rest } = props;
